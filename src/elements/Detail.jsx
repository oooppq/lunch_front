              ...
              if (s)
                return (
                  <div key={m.id} className="menus">
                    <span className="menu">{m.menu_name}</span> <span className="price"><span className="line">{m.menu_price} </span> {s.sale_price}</span>
                  </div>
                );
              else
                return (
                  <div key={m.id} className="menus">
                    <span className="menu">{m.menu_name}</span> <span className="price"> {m.menu_price}</span>
                  </div>
                );
            })}
          </div>
